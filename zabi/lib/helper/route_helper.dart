...
class RouteHelper {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: dhikrCount,
        page: () => const DhikrCountScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: addDhikr,
        page: () => LocalDhikrAddScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
    ...
    GetPage(
        name: duaView,
        page: () => const DuasViewScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: sifatName,
        page: () => const SifatNameScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: sifatNameDetaile,
        page: () => const SifatNameDetailsScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
    ...
    GetPage(
        name: allHadith,
        page: () => const AllHadithScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: hadithDetails,
        page: () => HadithDetailsScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: hadithBookName,
        page: () => HadisBookNameScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: haramIngredientsFood,
        page: () => const HaramIngredientsFood(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: haramFoodDetaile,
        page: () => const HaramFoodDetaileInfoScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
    ...
    GetPage(
        name: suraDetaile,
        page: () => const SuraDetaileScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
        name: duaAdd,
        page: () => LocalDuaAddScreen(
              appBackButton: true,
            ),
        transition: Transition.cupertinoDialog),
    GetPage(
