...
//------------- All result TextEditingController Section   ------------//
  ...
  final isApiNisabExist = TextEditingController(
      text: Get.find<MosqueSettingsController>()
                  .mosqueSettingsApiData!
                  .data!
                  .automaticPayerTime ==
              true
          ? null
          : Get.find<MosqueSettingsController>()
                      .mosqueSettingsApiData!
                      .data!
                      .zakatNisab ==
                  null
              ? null
              : "${Get.find<MosqueSettingsController>().mosqueSettingsApiData!.data!.currencySymbol} ${Get.find<MosqueSettingsController>().mosqueSettingsApiData!.data!.zakatNisab}");
...
//------------- Variable for Own section ------------//
  ...
  getZakat() {
    if (equalResult > double.parse(totalNisab.text)) {
      ...
      totalZakat.text =
          "${Get.find<MosqueSettingsController>().mosqueSettingsApiData!.data!.automaticPayerTime == true ? "" : Get.find<MosqueSettingsController>().mosqueSettingsApiData!.data!.currencySymbol} $total_zakat";
